...
required_files=(
  ...
  "$ROOT_DIR/scripts/run-ios-replay-bundle.py"
  ...
  "$ROOT_DIR/scripts/test_run_ios_replay_bundle.py"
...
python3 -m unittest "$ROOT_DIR/scripts/test_run_ios_replay_bundle.py" >/dev/null
...
grep -q "replay_verification" "$ROOT_DIR/scripts/run-ios-replay-bundle.py"
